...
def define_arguments_prompted(parser):
    ...
    parser.add_argument("--setting", choices=['base', 'enhanced', 'clean'], help="base or enhanced setting", required=True)
    parser.add_argument("--prompt_type", choices=['InjecAgent', 'hwchase17_react','InjecAgent_Delimit','InjecAgent_Repeat'], help="prompt type", required=True)

...
class EmailIPIABuilder(QAPIABuilder):
    ...
    system_prompt_template = (
        ...
        "Here is the content of the email{guidance}. The content is enclosed in '<<' and '>>':\n"
        "<<\n"         # 开始分隔符
        "{context}\n"  # 邮件内容
        ">>"           # 结束分隔符
    )
    
    # === [修改点 2] User Prompt: 添加分隔符逻辑并移除 Repeat Prompt ===
    user_prompt_template = [
        # 情况 1: 有 System Prompt 时
        "Question: {question}",
        
        # 情况 2: 无 System Prompt 时
        (
